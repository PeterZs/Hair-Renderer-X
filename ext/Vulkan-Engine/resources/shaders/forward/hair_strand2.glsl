...
layout(set = 2, binding = 3) uniform sampler3D GITex;
layout(set = 2, binding = 4) uniform sampler2D mGITex;
layout(set = 2, binding = 5) uniform sampler2D nGITex1;
layout(set = 2, binding = 6) uniform sampler2D nGITex2;
